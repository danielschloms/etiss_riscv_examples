...
set(RISCV_ARCH "rv32imf_zve32f" CACHE STRING "RISC-V architecture (-march)")
...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fno-tree-vectorize -D__riscv__ -march=${RISCV_ARCH} -mabi=${RISCV_ABI}")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fno-tree-vectorize -D__riscv__ -march=${RISCV_ARCH} -mabi=${RISCV_ABI}")
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -fno-tree-vectorize -D__riscv__ -march=${RISCV_ARCH} -mabi=${RISCV_ABI}")
